...
public class WeekFragment extends Fragment {
    ...
    private void resetViewport() {
        ...
        v.bottom = Float.parseFloat(StocksFragment.result.getData().get(0).get(1))-10;
        v.top = Float.parseFloat(StocksFragment.result.getData().get(numberOfPoints-1).get(1))+10;
        v.left = 0;
