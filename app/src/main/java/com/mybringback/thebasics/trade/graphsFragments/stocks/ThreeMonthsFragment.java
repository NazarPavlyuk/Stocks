package com.mybringback.thebasics.trade.graphsFragments.stocks;
...
public class ThreeMonthsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<numberOfPoints; i++){
            comparedResults.add(Float.parseFloat(StocksFragment.result.getData().get(i).get(1)));
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_three_months, container, false);

        setHasOptionsMenu(true);

        chart = (LineChartView) rootView.findViewById(R.id.chart_three_months);
    ...
    private void generateValues() {
        for (int i = 0; i < maxNumberOfLines; ++i) {
            for (int j = 0; j < numberOfPoints; ++j) {
                ...
                currentValue = Float.parseFloat(StocksFragment.result.getData().get(j).get(1));
    ...
    private void resetViewport() {
        ...
        /*v.bottom = Float.parseFloat(MainActivity.result.getData().get(0).get(1))-50;
        v.top = Float.parseFloat(MainActivity.result.getData().get(numberOfPoints-1).get(1))+50;*/
