 ...
 */
public class YearResourcesFragment extends Fragment {
    public YearResourcesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_resources_year, container, false);

        setHasOptionsMenu(true);

        chart = (LineChartView) rootView.findViewById(R.id.chart_resources_year);
    ...
    private void toggleCubic() {
        ...
        if (isCubic) {
            ...
            final Viewport v = new Viewport(chart.getMaximumViewport());
            v.bottom = (float) comparedResults.get(numberOfPoints-1)-(50/10);
            v.top = (float) comparedResults.get(0) +(50/10);
