...
import com.mybringback.thebasics.trade.JSONmodel.DataService1;

import com.mybringback.thebasics.trade.graphs.ResourcesGraphActivity;
import com.mybringback.thebasics.trade.adapter.ResourceAdapter;
...
public class ResourcesFragment extends Fragment {
    ...
    private List<Dataset> resourceDataListMain = new ArrayList<>();
    public static Dataset result1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(DataSave element:elements){
            ...
            for (int j = 0; j < getBlockDividedByComa.length; j++) {
             ...
             resourceDataListMain.add(new Dataset(secondlyAddedElements, element.getDataset_code(), element.getName()));
        }
        ...
        mAdapter = new ResourceAdapter(getContext(), resourceDataListMain);
        ...
        ItemTouchHelper.SimpleCallback simpleCallback = new ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int position) {
                 resourceDataListMain.remove(viewHolder.getAdapterPosition());
                try {
                    final DataSave element = realm.where(DataSave.class).equalTo("dataset_code",  resourceDataListMain.get(viewHolder.getAdapterPosition()).getDataset_code()).findFirst();
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(context, recyclerView ,new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    @Override public void onItemClick(View view, int position) {
                        // do whatever
                        result1 =  resourceDataListMain.get(position);
                        Intent intent = new Intent(getActivity(), ResourcesGraphActivity.class);
                        intent.putExtra(Dataset.class.getCanonicalName(), result1);
        ...
        sv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Retrofit retrofit = new Retrofit.Builder()
                        ...
                        .build();
                DataService1 service = retrofit.create(DataService1.class);
                ...
                call.enqueue(new Callback<Main>() {
                    ...
                    public void onResponse(Call<Main> call, Response<Main> response) {
                        ...
                        try {
                            ...
                            realm.commitTransaction();
                            resourceDataListMain.add(response.body().getDataset());
                            mAdapter.notifyDataSetChanged();
