 ...
 */
public class ThreeMonthsResourcesFragment extends Fragment {

    public ThreeMonthsResourcesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_resources_three_months, container, false);

        setHasOptionsMenu(true);

        chart = (LineChartView) rootView.findViewById(R.id.chart_resources_three_months);
    ...
    private void toggleCubic() {
        ...
        if (isCubic) {
            ...
            final Viewport v = new Viewport(chart.getMaximumViewport());
            v.bottom = (float) comparedResults.get(numberOfPoints-1)-(15/10);
            v.top = (float) comparedResults.get(0)+(15/10) ;
