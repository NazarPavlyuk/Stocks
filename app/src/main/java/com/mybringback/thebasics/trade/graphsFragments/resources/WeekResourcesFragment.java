 ...
 */
public class WeekResourcesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_resources_week, container, false);

        setHasOptionsMenu(true);

        chart = (LineChartView) rootView.findViewById(R.id.chart_resources_week);
    ...
    private void resetViewport() {
        ...
        /*v.bottom = Float.parseFloat(ResourcesFragment.result1.getData().get(0).get(1))-10;
        v.top = Float.parseFloat(ResourcesFragment.result1.getData().get(numberOfPoints-1).get(1))+10;*/
    ...
    private void toggleCubic() {
        ...
        if (isCubic) {
            ...
            final Viewport v = new Viewport(chart.getMaximumViewport());
            v.bottom = (float) comparedResults.get(numberOfPoints-1)-(5/10);
            v.top = (float) comparedResults.get(0)+(5/10) ;
